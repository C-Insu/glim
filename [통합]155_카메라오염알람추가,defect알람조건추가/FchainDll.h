...
//pitch   : Image 피치 
//height  : Image 전체 높이
extern "C" void PASCAL EXPORT FChain_SetChainData(int object, LPBYTE fm, int skipx, int skipy, int minboundary,
...
//return : 찾은 Blob의수 
extern "C" int PASCAL EXPORT  FChain_FastChain(int left, int top, int right, int bottom);

//N번째 Blob의 중심을 구한다.
extern "C" void PASCAL EXPORT FChain_Center(int N, double *cx, double *cy);

//N번째 Blob의 경계만 가지고 중심을 구한다.
extern "C" void PASCAL EXPORT FChain_CenterWithBoundary(int N, double *cx, double *cy);
...
//N번째 Blob의 X최대값 
extern "C" int PASCAL EXPORT  FChain_FindMaxX(int N);

//N번째 Blob의 X최소값 
extern "C" int PASCAL EXPORT  FChain_FindMinX(int N);

//N번째 Blob의 Y최대값 
extern "C" int PASCAL EXPORT  FChain_FindMaxY(int N);

//N번째 Blob의 Y최소값 
extern "C" int PASCAL EXPORT  FChain_FindMinY(int N);
...
extern "C" void PASCAL EXPORT FChain_FineDistFromPoint(int N, double Cx,double Cy, double *min, double *max, double *avg);
